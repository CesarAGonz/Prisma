...
input ComboSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ComboWhereInput
  AND: [ComboSubscriptionWhereInput!]
}
...
input ComboUpdateManyMutationInput {
  name: String
  description: String
}

input ComboWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
...
input MembershipWhereInput {
  ...
  genere_not: String
  genere_in: [String!]
  genere_not_in: [String!]
  genere_lt: String
  genere_lte: String
  genere_gt: String
  genere_gte: String
  genere_contains: String
  genere_not_contains: String
  genere_starts_with: String
  genere_not_starts_with: String
  genere_ends_with: String
  genere_not_ends_with: String
  points: Int
  points_not: Int
  points_in: [Int!]
  points_not_in: [Int!]
  ...
  points_gte: Int
  type: TypeMembership
  type_not: TypeMembership
  type_in: [TypeMembership!]
  type_not_in: [TypeMembership!]
...
input MovieWhereInput {
  ...
  lenguage_not: String
  lenguage_in: [String!]
  lenguage_not_in: [String!]
  lenguage_lt: String
  lenguage_lte: String
  lenguage_gt: String
  lenguage_gte: String
  lenguage_contains: String
  lenguage_not_contains: String
  lenguage_starts_with: String
  lenguage_not_starts_with: String
  lenguage_ends_with: String
  lenguage_not_ends_with: String
  premiere: DateTime
  premiere_not: DateTime
  premiere_in: [DateTime!]
  premiere_not_in: [DateTime!]
  premiere_lt: DateTime
  premiere_lte: DateTime
  premiere_gt: DateTime
  premiere_gte: DateTime
  AND: [MovieWhereInput!]
}
...
type Mutation {
  ...
  createCombo(data: ComboCreateInput!): Combo!
  updateCombo(data: ComboUpdateInput!, where: ComboWhereUniqueInput!): Combo
  updateManyComboes(data: ComboUpdateManyMutationInput!, where: ComboWhereInput): BatchPayload!
  upsertCombo(where: ComboWhereUniqueInput!, create: ComboCreateInput!, update: ComboUpdateInput!): Combo!
  deleteCombo(where: ComboWhereUniqueInput!): Combo
  deleteManyComboes(where: ComboWhereInput): BatchPayload!
...
type Query {
  ...
  combo(where: ComboWhereUniqueInput!): Combo
  comboes(where: ComboWhereInput, orderBy: ComboOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Combo]!
  comboesConnection(where: ComboWhereInput, orderBy: ComboOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ComboConnection!
...
type Subscription {
  ...
  combo(where: ComboSubscriptionWhereInput): ComboSubscriptionPayload
...
input UserUpdateDataInput {
  ...
  lastName: String
  points: Int
  membership: MembershipUpdateOneInput
  type: TypeUser
  token: String
